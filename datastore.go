...
//
// TODO Remove code duplication with ResolveEntityKey
// Perhaps create an EntityKeyResolver type that
// knows how to assign new keys or resolve in case
// the key is re-creatable
func (this Datastore) AssignEntityKey(e entity) error {
	...
	kind, hasParent := ExtractEntityKindMetadata(e)

	if hasParent && e.Parent() == nil {
